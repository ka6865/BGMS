...
const REPLY_INSTRUCTION = [
  ...
  "질문이 게시글 자체의 요약이나 게시글에 나타난 반응을 묻는 경우에는 post만 바탕으로 답할 수 있습니다. 이때 반드시 '이 글에서는' 또는 '게시글에 따르면'처럼 범위를 밝히고 사실 검증이 끝난 것처럼 표현하지 마세요.",
  "의견이나 평가를 묻는 경우에는 post와 sources에 드러난 내용만 근거로 균형 잡힌 판단을 제시하세요. '제 생각에는' 또는 'BGMS AI의 판단으로는'처럼 의견임을 밝히고, 확인된 사실과 의견을 구분하며 새로운 사실을 만들어내지 마세요.",
