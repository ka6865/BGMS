...
import { fetchPlayerMatchesPaginated, normalizePlayerMatchesPage } from "@/lib/pubg/playerMatches";
 ...
 export async function GET(request: NextRequest) {
  ...
  try {
    const result = await fetchPlayerMatchesPaginated(supabase, nickname, platform, page, 20);
